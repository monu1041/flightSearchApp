...
export default class App extends Component {
  ...
  render() {
    return (
      <View>
        <Header back={"Back"} title={"Flight Booking"} goBack={this.goBack} iconName="ios-arrow-round-back" />
        <View style={{ height: 30, }}></View>
        <View style={styles.flightTypes}>
          <Text style={{ fontSize: 30, alignSelf: 'center', color: "blue" }} >One Way</Text>{this.renderSeparator()}
          <Text style={{ fontSize: 30, alignSelf: 'center' }} >Round-Trip</Text>{this.renderSeparator()}
          <Text style={{ fontSize: 30, alignSelf: 'center' }} >Multi-City</Text>
        </View>
        ...
        <View style={{ height: 30, }}></View>
        <View style={{ width: "80%", alignSelf: "center", height: 150, backgroundColor: "#231C99", borderRadius: 20 }}>
          <Text style={{ fontSize: 100, alignSelf: 'center', color: "white" }}>Search</Text>
        </View>
      </View>
    );
  }
